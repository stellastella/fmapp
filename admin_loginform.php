...
<?php
$login_form = <<<EOD
<form name="login" id="login" method="POST" action="admin_login.php">
...
<p><label for="password">Please Enter Password: </label><input type="password" size="40" name="password" id="password" value="password" /></p>
